...
namespace OfficialXVIID\CI4Favicon\Templates;
...
class Html{
     ...
     * @return string 
     */
    public static function output($noOldApple = false, $noAndroid = false, $noMs = false, $tileColor = '#EC1D00', $browserConfigFile = '', $appName = '')
    {
        $result = array();
        if (!$noMs)
        {
